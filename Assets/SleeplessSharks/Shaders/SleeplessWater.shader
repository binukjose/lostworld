...
Properties {
	...
	_InvFadeParameter ("Auto blend parameter (Edge, Shore, Distance scale)", Vector) = (0.15 ,0.15, 0.5, 1.0)
...
CGINCLUDE
	...
	half4 frag( v2f i ) : SV_Target
	{
		...
		float spec = max(0.0,pow (nh, 500.0));
		...
		half4 baseColor = ExtinctColor (_BaseColor, i.viewInterpolator.w * _InvFadeParameter.w);
